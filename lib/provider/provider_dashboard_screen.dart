...
class ProviderDashboardScreenState extends State<ProviderDashboardScreen> {
  ...
  bool get isProfileFragmentIsBooking =>
      fragmentList[currentIndex].runtimeType ==
      ProviderHomeFragment().runtimeType;
                  ...
                  return IconButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ProviderProfileFragment()));
                    },
                    icon: (appStore.isLoggedIn &&
                        ...
                        : profile.iconImage(color: white, size: 26),
          ...
          child: NavigationBarTheme(
            ...
            child: NavigationBar(
              ...
              destinations: [
                ...
                NavigationDestination(
                  icon: builder.iconImage(color: appTextSecondaryColor),
